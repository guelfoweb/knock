...
from knockpy.modules import headers
from knockpy.modules import stats
from knockpy.modules import target
from knockpy.modules import wildcard
from knockpy.modules import wordlist
from knockpy.modules import subscan
from knockpy.modules import zonetransfer
...
def show_banner(typo):
    ...
    # print code, reason
    # FIXME: code is undefined
    if typo == 'code' and code:
        print(code.ljust(18) + reason + '\n')

    # print headers
    # FIXME header is undefined
...
def subdomain_scan():
    # FIXME targetlist undefined
    for current_target in targetlist:
        if wildcard_detected:
            #FIXME wcode undefined
            result = bypass_wildcard(target, wcode)
        else:
            result = get_target(current_target, False, False)
